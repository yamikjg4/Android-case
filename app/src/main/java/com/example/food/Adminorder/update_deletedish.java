...
public class update_deletedish extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_deletedish);
        ...
        dataa.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Delete_dish.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        AlertDialog.Builder builder = new AlertDialog.Builder(update_deletedish.this);
                        ...
                        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                AlertDialog.Builder food = new AlertDialog.Builder(update_deletedish.this);
                                food.setMessage("Your Dish Has Been Deleted!");
                                food.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        startActivity(new Intent(update_deletedish.this, Admin.class));
                                    }
                                });
                ...
                progressDialog = new ProgressDialog(update_deletedish.this);
                ...
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Glide.with(update_deletedish.this).load(updateDishModel.getImageURL()).into(imageButton);
    ...
    private void updatedesc(String buri) {
        ...
        FoodSupplyDetails info = new FoodSupplyDetails(dishes,quantity,price,description,buri,ID,restaurantId);
        firebaseDatabase.getInstance().getReference("FoodSupplyDetails").child(State).child(City)
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                Toast.makeText(update_deletedish.this,"Dish Updates Successfully!",Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        if(imageuri != null){
            ...
            ref.putFile(imageuri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception e) {
                    progressDialog.dismiss();
                    Toast.makeText(update_deletedish.this,"Failed:"+e.getMessage(),Toast.LENGTH_LONG).show();
                }
